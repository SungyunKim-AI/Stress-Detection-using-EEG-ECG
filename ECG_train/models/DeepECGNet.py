...
from tensorflow.keras.layers import Dense, Flatten, Dropout, GlobalAveragePooling1D, Activation
...
def DeepECGNet(input_dim, dropoutRate=0.5, temperature=1):
    ...
    dense = Dense(256, kernel_initializer='normal', activation='relu')(flatten)
