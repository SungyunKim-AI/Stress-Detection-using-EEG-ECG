...
def DeepConvNet(nb_classes, Chans, Samples, dropoutRate = 0.5):
    ...
    block1       = MaxPooling2D(pool_size=(1, 3), strides=(1, 3), data_format='channels_first')(block1)
    ...
    block2       = MaxPooling2D(pool_size=(1, 3), strides=(1, 3), data_format='channels_first')(block2)
    ...
    block3       = MaxPooling2D(pool_size=(1, 3), strides=(1, 3), data_format='channels_first')(block3)
    ...
    block4       = MaxPooling2D(pool_size=(1, 3), strides=(1, 3), data_format='channels_first')(block4)
